...
Used to check assets and liabilities at month end.
...
- Date: the last day of the month you are reporting.
...
- Horizontal and vertical layouts are read; both sides must total the same.
