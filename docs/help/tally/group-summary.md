...
A single group with its ledgers, most often Sundry Debtors or Sundry Creditors.
...
- Group: the group you are asked for.
...
- Party ledger names are replaced with tokens before anything is sent for analysis.
