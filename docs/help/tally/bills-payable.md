...
Outstanding supplier bills with due dates, used for ageing.
...
- Show bill date, reference, party, pending amount, due date and overdue days.
...
- Party headings or a party column are both read; amounts with Dr/Cr suffixes are recognised.
