...
Used to check the MIS income statement against the books.
...
- Period: the financial year to date ending with the month you are reporting.
- Detail: show ledgers under each group.
...
- Horizontal (two-sided) and vertical layouts are both read.
- Nett Profit or Nett Loss must be present.
