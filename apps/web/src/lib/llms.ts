...
const SUMMARY =
  "Upload the raw trial balance from any accounting system and get a checked monthly management report: an Excel workbook with live formulas, a dashboard, written commentary and a chat that answers questions about the figures. Every number is computed by a deterministic engine and traceable to its ledger; the AI maps ledgers and writes sentences and never outputs a number.";
