 ...
 *
 * The rule is deliberately conservative: a name that fails is simply never proposed; the account's own
 * rule still works for that account. An admin still reviews every candidate.
 *
